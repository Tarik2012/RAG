...
urlpatterns = [
    ...
    path("projects/<int:project_id>/memories/", project_memories, name="project_memories"),
    path("audits/<int:audit_run_id>/", audit_report, name="audit_report"),
    ...
    path("memories/<int:memory_id>/delete/", memory_delete, name="memory_delete"),
